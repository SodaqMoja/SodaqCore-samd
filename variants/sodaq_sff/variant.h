...
#ifndef _VARIANT_SODAQ_SFF_
#define _VARIANT_SODAQ_SFF_
...
// LEDs
#define PIN_LED_RED          (17u)
#define PIN_LED_GREEN        (19u)
#define PIN_LED_BLUE         (14u)

#define PIN_ACCEL_INT1       (5u)
#define PIN_ACCEL_INT2       (4u)
#define PIN_MAG_INT          (50u)

#define PIN_GPS_ENABLE       (18u)
#define PIN_GPS_TIMEPULSE    (21u)

#define PIN_SARA_ENABLE      (49u)
// #define PIN_SARA_RESET       (49u)
#define PIN_SARA_R4XX_TOGGLE (15u)
#define PIN_SARA_TX_ENABLE   (51u)
#define PIN_SARA_STATUS      (52u)
