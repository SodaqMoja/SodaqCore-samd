...
buildSDUBootSketch "SODAQ:samd:sodaq_sff" "$OUTPUT_PATH/sodaq_sff.h"
buildSDUBootSketch "SODAQ:samd:sodaq_explorer" "$OUTPUT_PATH/sodaq_explorer.h"
buildSDUBootSketch "SODAQ:samd:sodaq_one_beta" "$OUTPUT_PATH/sodaq_one_beta.h"
buildSDUBootSketch "SODAQ:samd:sodaq_one" "$OUTPUT_PATH/sodaq_one.h"
buildSDUBootSketch "SODAQ:samd:sodaq_autonomo" "$OUTPUT_PATH/sodaq_autonomo.h"
